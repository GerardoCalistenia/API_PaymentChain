...
@Tag(name = "Billing APU", description = "API that serve all functionality for management Invoices")
@RestController
...
public class InvoiceRestController {
    ...
    @Operation(description = "Return all invoices bundled into Respones", summary = "Return 204 if no data found")
