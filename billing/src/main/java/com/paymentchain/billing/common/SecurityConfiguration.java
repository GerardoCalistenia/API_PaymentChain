...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        // 01- Full security in order to ask by user and password before to acces
        // swagger ui
        http.csrf().disable()
        ...
        // http
        // /*- This property is active by default, we need to deactivate in order to
        // allow ask by user and password on post methods.
        //
        // - Cross site request forgery (CSRF or XSRF) refers to an attack that makes
        // the end-user perform unwanted actions within a web application
        ...
        // //Using defauls values, we can define role on .properties file that will be
    ...
    // This Handlers implement the CorsConfigurationSource interface in order to
    // provide a CorsConfiguration for each request.
    @Bean
